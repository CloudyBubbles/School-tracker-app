                ...
                <div key={a.id}>
                  ...
                  >
                    ...
                    <div className="ml-4 shrink-0 flex items-center gap-2">
                      ...
                      {overdue && (
                        <span className="text-xs font-semibold text-red-600 bg-red-50 border border-red-100 px-1.5 py-0.5 rounded-md">
                          Overdue
                        </span>
                      )}
                      {soon && !overdue && (
                        <span className="text-xs font-semibold text-amber-700 bg-amber-50 border border-amber-100 px-1.5 py-0.5 rounded-md">
                          Soon
                        </span>
                      )}
                    </div>
